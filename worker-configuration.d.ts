/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96fbd9bf21776fb69689f59afab7d474)
// Runtime types generated with workerd@1.20260401.1 2025-09-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
	}
	interface DevelopmentEnv {
		NOVEL_VIEWER_STORAGE: R2Bucket;
		AI: Ai;
		ASSETS: Fetcher;
		SECRET_ENVIRONMENT_STATUS: "development";
	}
	interface StagingEnv {
		NOVEL_VIEWER_STORAGE: R2Bucket;
		AI: Ai;
		ASSETS: Fetcher;
		SECRET_ENVIRONMENT_STATUS: "staging";
	}
	...
	interface Env {
		...
		AI: Ai;
		ASSETS: Fetcher;
		SECRET_ENVIRONMENT_STATUS?: "development" | "staging" | "live";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_ENVIRONMENT_STATUS">> {}
}
